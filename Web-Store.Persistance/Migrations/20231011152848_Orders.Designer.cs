...
namespace Web_Store.Persistance.Migrations
{
    ...
    [Migration("20231011152848_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_Store.Domain.Entites.Finances.RequestPay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Web_Store.Domain.Entites.Orders.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Web_Store.Domain.Entites.Orders.OrderDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Web_Store.Domain.Entites.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2023, 10, 11, 18, 58, 48, 536, DateTimeKind.Local).AddTicks(2135),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2023, 10, 11, 18, 58, 48, 537, DateTimeKind.Local).AddTicks(6348),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2023, 10, 11, 18, 58, 48, 537, DateTimeKind.Local).AddTicks(6436),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("Web_Store.Domain.Entites.Orders.Order", b =>
                {
                    b.HasOne("Web_Store.Domain.Entites.Finances.RequestPay", "RequestPay")
                        .WithMany("orders")
            ...
            modelBuilder.Entity("Web_Store.Domain.Entites.Orders.OrderDetail", b =>
                {
                    b.HasOne("Web_Store.Domain.Entites.Orders.Order", "Order")
